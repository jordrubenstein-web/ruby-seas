...
/** Local assets — avoids broken `next/image` when remote Unsplash fetch fails (TLS / network). */
const retailImg = "/home/dual-retail.jpg";
const wholesaleImg = "/home/dual-wholesale.jpg";
      ...
      <div className="mx-auto max-w-content px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        ...
        <div className="mt-12 flex flex-col gap-4 lg:h-[420px] lg:flex-row lg:gap-0">
          ...
          >
            <Image
              src={retailImg}
              alt="Fresh fish and seafood at a retail market display"
              fill
          ...
          >
            <Image
              src={wholesaleImg}
              alt="Shipping containers at port — wholesale import and logistics"
              fill
              className="object-cover transition duration-700 group-hover:scale-105"
              sizes="(max-width: 1024px) 100vw, 50vw"
            />
