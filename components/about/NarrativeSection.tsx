...
const ACT_BLOCKS: ActBlock[] = [
  ...
  },
  {
    ...
    body: "Every product we sell meets both EU and FDA health standards. Our Bahamas spiny lobster fishery is MSC-certified sustainable — a day boat fishery, once frozen. Zero shortcuts.",
    ...
    >
      {ACT_BLOCKS.map((act, i) => (
        ...
        >
          ...
          >
            <ActVisual video={act.video} poster={act.poster} />
