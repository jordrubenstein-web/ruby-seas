...
export const GLOBAL_REACH_LOCATIONS: GlobalReachLocation[] = [
  ...
  { id: "gt", name: "Guatemala", lat: 15.5, lng: -90.25 },
  ...
  { id: "cy", name: "Cyprus", lat: 35.0, lng: 33.0 },
  { id: "dk", name: "Denmark", lat: 56.0, lng: 10.0 },
  { id: "de", name: "Germany", lat: 51.0, lng: 10.5 },
  { id: "gr", name: "Greece", lat: 39.0, lng: 22.0 },
  { id: "it", name: "Italy", lat: 42.5, lng: 12.5 },
  { id: "nl", name: "Netherlands", lat: 52.1, lng: 5.3 },
  { id: "pt", name: "Portugal", lat: 39.5, lng: -8.0 },
  { id: "gb", name: "United Kingdom", lat: 54.0, lng: -2.0 },
